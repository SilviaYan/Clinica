    ...
    <form name="pacientes" id="pacientes" action="<?php echo base_url(); ?>Pacientes/modPaciente" method="post">
      ...
      <div class="row">
        <div class="form-group col-xs-6 col-md-4">
          Estado:<select id="inputState" name="asegurado" value="<?= $paciente[0]['pEstado'] ?>" class="form-control">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
          Asegurado:<select id="inputState" name="asegurado" value="<?= $paciente[0]['pAsegurado'] ?>" class="form-control">
